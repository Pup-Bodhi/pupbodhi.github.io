...
import profilePhoto from "./../media/imgs/profile-photo.png"
...
export default function Home() {
    ...
    return (
        <div className="flex flex-column gap-4">
            <div className="flex row gap-2 align-items-center lg:gap-5">
                <div id="cover-photo">
                    <img src={profilePhoto} alt="Profile photo" className="border-transparent border-solid border-1 border-round-2xl w-8rem lg:w-12rem" width="200"></img>
                </div>
                <div>
                    <div className="flex align-items-baseline flex-wrap justify-content-center lg:gap-3 lg:flex-nowrap lg:justify-content-start">
                        <div className="font-starline text-7xl lg:text-8xl">Bodhi</div>
                        <div className="font-urbanist text-l -mt-3 lg:text-3xl lg:m-0">(he/him/it)</div>
                    </div>
                    <div className="text-center font-urbanist text-2xl lg:text-3xl">
                        Tiny, cuddly, adorable rubber dawg!
                    </div>
                </div>
            </div>
            <div className="flex flex-row gap-4 flex-wrap lg:gap-4 justify-content-center align-content-center">
                <div className="iconButton bluesky" onClick={() => window.location.href = "https://bsky.app/profile/pupbodhi.com"}>
            ...
            <div className="flex flex-row gap-3 lg:gap-5 justify-content-center align-items-center flex-shrink-1">
                <div>
                    <div className="font-starline text-3xl lg:text-5xl font-bold p-2 text-center">want to play?</div>
                    <div className="text-l text-center">I'm always looking for quality play partners to share pawsitive experiences with!
                        Take a look at my about page to find out what makes me tick, and fill out the vetting form to express your interest!
                    </div>
                </div>
                <div className="flex flex-column gap-4 flex-grow-1 w-full">
                    <Button className="button" label="about me" icon="pi pi-angle-right" iconPos="right" onClick={() => navigate("/about")} severity="info" />
                    <Button className="button" label="vetting form" icon="pi pi-angle-right" iconPos="right" onClick={() => navigate("/vetting-form")} severity="info" />
                </div>
            </div>
        </div>
    )
